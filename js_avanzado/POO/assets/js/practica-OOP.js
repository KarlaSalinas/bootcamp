...
class Carro{
    ...
    toString(){
        document.write(`El carro ${this.marca}, modelo ${this.modelo} del color ${this.color} que tiene ${this.numeroPuertas} de puertas, va a una velocidad de ${this.velocidad} km/h <br>`);
    }
}
